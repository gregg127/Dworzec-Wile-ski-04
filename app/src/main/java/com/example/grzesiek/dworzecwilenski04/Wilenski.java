...
public class Wilenski extends AppCompatActivity {
    ...
    private void addComponents(){
        mEdit = (EditText)findViewById(R.id.timeTextFieldWilenski);
        output = (CheckedTextView)findViewById(R.id.outputWilenski);
        output.setMovementMethod(new ScrollingMovementMethod());
        button = (Button) findViewById(R.id.checkScheduleWilenski);
